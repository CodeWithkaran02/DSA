...
public class ringrotete {
    public static void main(String args[]) {
        ...
        ringrotete(mat, shell, k);
        display(mat);

    }

    public static void ringrotete(int[][] mat, int shell, int k) {
        Integer arr[] = fill1d(mat, shell);
        rotate(arr, k);
        fill2d(mat, shell, arr);
    }

    public static Integer[] fill1d(int mat[][], int shell, int r) {
